...
const searchData = [
    ...
    { title: "The Formula for Positive Twist: Handling Words like 'Rape,' 'Murder,' and 'Terrorism'", url: "/articles/the-formula-for-positive-twist-handling-extreme-negative-words", type: "Strategy", keywords: "extreme negative words wat ssb handling negative words word association test strategy officer like qualities dipr assessment toxic words logic" },
    { title: "How Important is the Psych Test in SSB Compared to GTO and Interview?", url: "/articles/how-important-is-psych-test-in-ssb-compared-to-other-tasks", type: "Analysis", keywords: "importance of psych test in ssb psychology vs gto ssb interview evaluation mansa vacha karmana dipr psychological assessment" },
